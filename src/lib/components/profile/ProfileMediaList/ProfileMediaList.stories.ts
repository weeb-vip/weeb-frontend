...
import { animeListConfig } from '$lib/components/profile/ProfileAnimeList';
import { workListConfig } from '$lib/components/profile/ProfileWorkList';
import {
  ANIME_COUNTS,
  ANIME_ENTRIES,
  WORK_COUNTS,
  ...
  urlAt,
  type StubResult,
} from '$lib/components/__stories__/profileFixtures';
