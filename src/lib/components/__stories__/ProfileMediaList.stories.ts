...
import ProfileMediaList from '$lib/components/profile/ProfileMediaList.svelte';
import { MediaListBloc } from '$lib/components/profile/MediaList.bloc.svelte';
import { animeListConfig } from '$lib/components/profile/ProfileAnimeList.bloc.svelte';
import { workListConfig } from '$lib/components/profile/ProfileWorkList.bloc.svelte';
import {
  ANIME_COUNTS,
  ANIME_ENTRIES,
  WORK_COUNTS,
...
import type { MediaListUrlPort } from '$lib/components/profile/MediaList.bloc.svelte';
