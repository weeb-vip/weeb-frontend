...
import { upsertAnime as upsertAnimeQuery, deleteAnime as deleteAnimeQuery } from "$lib/services/query-options";
import type { loggedInStore, loginModalStore } from '$lib/stores/auth';
